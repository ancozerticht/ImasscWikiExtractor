...
@Path("support-skill-mastery-da")
@Dependent
class SupportSkillMasteryDaListController @Inject constructor(
    private val service: SupportSkillListService
) {
    @GET
    @Produces("text/csv")
    fun download(): String {
        val supportSkillQuickChart = service.getSupportSkillMasteryDaList()
