...
@Path("support-skill-mastery-me")
@Dependent
class SupportSkillMasteryMeListController @Inject constructor(
    private val service: SupportSkillListService
) {
    @GET
    @Produces("text/csv")
    fun download(): String {
        val supportSkillQuickChart = service.getSupportSkillMasteryMeList()
