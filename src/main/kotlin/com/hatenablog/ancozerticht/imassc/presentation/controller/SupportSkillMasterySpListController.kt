...
@Path("support-skill-mastery-sp")
@Dependent
class SupportSkillMasterySpListController @Inject constructor(
    private val service: SupportSkillListService
) {
    @GET
    @Produces("text/csv")
    fun download(): String {
        val supportSkillQuickChart = service.getSupportSkillMasterySpList()
